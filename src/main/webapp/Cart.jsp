...
<html lang="en">
    ...
    <body>
        ...
        <script>
                                        function updateTotal(countProduct) {
                                            console.log("kladh");
                                            var quantityInput = document.getElementById('number' + countProduct);
                                            var quantity = parseInt(quantityInput.value);
                                            var productPrice = document.getElementById('price' + countProduct);
                                            var product = parseInt(productPrice.value);

                                            // Tính tổng giá trị mới
                                            var totalPrice = quantity * product;

                                            // Cập nhật giá trị hiển thị tổng giá trị

                                            var totalPriceElement = document.querySelector('#price' + countProduct);
