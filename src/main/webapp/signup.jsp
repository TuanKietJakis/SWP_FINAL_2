<%-- Document : signup Created on : Sep 18, 2023, 5:23:42 PM Author : Truc Vy CE171243 --%>
    ...
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        ...
        <body>
            <div class="Signup_Container">
                ...
                <div class="Signup_c_right">
                    ...
                    <div class="Sign_up">
                        <form action="/SignUp" method="POST" id="form_sign_up" class="Sign_up_form">
                            ...
                            <div class="input_box">
                                <input type="text" name="txtUsername" id="username" placeholder="Username"><i
                ...
                <script src="/js/VyScript/signup.js"></script>
                <script>
                <%
